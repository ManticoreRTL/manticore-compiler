...
class ANDTester extends SingleInstructionTest {
  val operator = BinaryOperator.AND
  behavior of "AND in Manticore Machine"
  it should "correctly handle random AND cases" in {f =>
