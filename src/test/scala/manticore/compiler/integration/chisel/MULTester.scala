...
class MULTester extends SingleInstructionTest {
  val operator = BinaryOperator.MUL
  behavior of "MUL in Manticore Machine"
  it should "correctly handle random MUL cases" in { f =>
